...
public class EmailAccountLoginPage {
	...
	public EmailHomePage DoSquirrelMailLogin(int iTestCaseRow) throws Exception
	{
		try
		{
		GenericMethods.sendKeys(UserName, ExcelUtil.getCellData(iTestCaseRow, ExcelUtil.GetColumnIndex(Constant.Col_SQEmailId)));
		GenericMethods.sendKeys(PasswdField, ExcelUtil.getCellData(iTestCaseRow, ExcelUtil.GetColumnIndex(Constant.Col_SQPassword)));
