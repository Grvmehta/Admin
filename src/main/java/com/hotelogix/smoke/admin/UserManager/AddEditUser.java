...
public class AddEditUser {
	...
	//	GenericMethods.sendKeys(lName_txtfild, "qe");
		...
		Thread.sleep(1000);
		GenericMethods.selectElementByIndex(department_drpDwn, 1);
		...
		GenericMethods.sendKeys(pass_TxtFld,"Test@1234568999" );
		GenericMethods.sendKeys(cnfPass_TxtFld, "Test@1234568999");
