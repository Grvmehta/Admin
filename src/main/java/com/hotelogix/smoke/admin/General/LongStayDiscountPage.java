...
public class LongStayDiscountPage {
	...
	@FindBy(xpath="	//input[@id='ruleVal']")
	public  WebElement txt_noOfNights;
	
	@FindBy(xpath="//input[@id='ruleDisc']")
	public  WebElement txt_discOrNights;
	
	@FindBy(xpath="//Select[@id='discType']")
	public  WebElement drp_longstay;
	...
	public void addPernightLongStay(String title,String noOfNights,String discOrNights) throws Exception
	{
		GenericMethods.clickElement(addDiscount);
		this.title=title;
		GenericMethods.sendKeys(txt_title, title);
		GenericMethods.sendKeys(txt_noOfNights, noOfNights);
		GenericMethods.sendKeys(txt_discOrNights, discOrNights);
	...
	public void addPercentageLongStay(String title,String noOfNights,String discOrNights) throws Exception
	{
		GenericMethods.clickElement(addDiscount);
		this.title=title;
		GenericMethods.sendKeys(txt_title, title);
		GenericMethods.sendKeys(txt_noOfNights, noOfNights);
		GenericMethods.sendKeys(txt_discOrNights, discOrNights);
		GenericMethods.selectElementByIndex(drp_longstay, 1);
		/*GenericMethods.sendKeys(txt_fromDisc, frmDisc);
		GenericMethods.sendKeys(txt_toDisc, toDisc);*/
