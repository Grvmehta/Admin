...
public class LastMinuteDiscountPage {
	...
	public void addlastMinuteDiscount(String title,String frmOcc,String toOcc,String frmDisc,String toDisc) throws Exception
	{
