...
public class ListofPackagesInPackageMaster {
	...
	public void fn_chkInclPkg() throws Exception
	{
        ...
        for(int i=2;i<=count;i++)
        {
            ...
            else
            {
                ...
                new AddEditPackage().fillPkgDetailsFD("2");
                new AddEditPackage().checkadded_addon();
                new AddMoreInclusions().select_inclusion();
	...
	public  String verifyAddedPKG(String ActualPkgName) throws InterruptedException{
		String Name=null;
		...
		for(int i=2;i<count;i++){
			...
			if(Name.contains(AddEditPackage.pkgName)){
				...
				System.out.println("Searched Package not found");
			}
	...
	public  void VerifyAddedPackage()
	{
		String value = null;
	...
	public  void verifysavedpkg(String value) throws Exception
	{
		try
		{
           ...
           for(int j=0;j<=list.size()-1;j++)
              {
               ...
               else
               {
                ...
                new attachPackages().AttachToFrondeskTC();
	...
	public void fn_chkInclChocBarPkg() throws Exception
	{
           ...
           for(int j=0;j<=list.size()-1;j++)
              {
               ...
               {
            	new ListofPackagesInPackageMaster().fn_NavigateToAddEditPackage();
                new AddEditPackage().fillPkgDetailsFD2("1");
                new AddEditPackage().checkadded_addon();
                new AddMoreInclusions().select_ChocBarIncl();
                new AddEditPackage().clickOnSave();
                new BasePage().fn_navigateFrontDskPkg();
                ListOfPackagesFrontdesk LOPF=new ListOfPackagesFrontdesk();
                LOPF.viewAll();
        ...
        public void fn_chkChocBarPAPkg() throws Exception
    	{
        	...
        	catch(Exception e)
        	{
        		...
        		AEP.checkadded_addon();
        		new AddMoreInclusions().select_ChocBarPA();
              AEP.clickOnSave();
              new BasePage().fn_navigateFrontDskPkg();
              ListOfPackagesFrontdesk LOPF=new ListOfPackagesFrontdesk();
              LOPF.viewAll();
