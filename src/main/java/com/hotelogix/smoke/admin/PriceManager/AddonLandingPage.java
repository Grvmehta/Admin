...
public class AddonLandingPage
{
	...
	public  void verify_savedAddOn(String value) throws Exception
	{
		String str = null;
		try
		{
           ...
           for(int j=0;j<=list.size()-1;j++)
              {
               ...
               {
            	clickAddAddons();
            	new SaveAddonsPage().fn_addChocBar();
