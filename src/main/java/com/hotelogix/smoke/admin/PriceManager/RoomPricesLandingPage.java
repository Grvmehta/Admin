...
public class RoomPricesLandingPage
{
	...
	@FindBy(xpath="//table[@class='table_price']//tr[2]//td[3]//table//tr[5]//td[13]//img[3]")
	...
	@FindBy(xpath="//table[@class='table-content']//tr[5]//td[13]/img")
	...
	@FindBy(xpath="//table//tr[5]//td[13]/img[@title='Save']")
	public static WebElement lastmin_save;

	@FindBy(xpath="//table//tr[6]//td[13]/img")
	...
	public String lastminrate() throws Exception
	{
			...
			{		
				...
				for(int i=2;i<=count;i++)
				{
					String data=GenericMethods.driver.findElement(By.xpath("//table[@class='table_price']//tr[2]//td[3]//tr["+i+"]")).getText();
				    if(data.contains("Last Min Rate"))
				    {
				    	Assert.assertEquals(data.contains("Last Min Rate"), true);
				    	GenericMethods.driver.findElement(By.xpath("//table[@class='table-content']//tr["+i+"]//td[13]/img")).click();
				    	WebElement ele=GenericMethods.driver.findElement(By.xpath("//table[@class='table_price']//tr[2]//td[3]//table//tr["+i+"]//td[2]//input"));
				    	ele.clear();
				    	ele.sendKeys("550.00");
				    	a="550.00";
				    	WebElement ele1=GenericMethods.driver.findElement(By.xpath("//table[@class='table_price']//tr[2]//td[3]//table//tr["+i+"]//td[3]//input"));
				    	ele1.clear();
				    	ele1.sendKeys("440");
				    	GenericMethods.driver.findElement(By.xpath("//table//tr["+i+"]//td[13]/img[@title='Save']")).click();
				    	savedLM=ele.getAttribute("value");
				    	break;
				    }			
	...
	public String webrate() throws Exception
	{
		try
		{
			...
			{
				String data=GenericMethods.driver.findElement(By.xpath("//table[@class='table_price']//tr[2]//td[3]//tr["+i+"]")).getText();
			    if(data.contains("Web Rate"))
			    {
			    	Assert.assertEquals(data.contains("Web Rate"), true);
			    	GenericMethods.driver.findElement(By.xpath("//table[@class='table-content']//tr["+i+"]//td[13]/img")).click();
			    	WebElement ele=GenericMethods.driver.findElement(By.xpath("//table[@class='table_price']//tr[2]//td[3]//table//tr["+i+"]//td[2]//input"));
			    	ele.clear();
			    	ele.sendKeys("550.00");
			    	...
			    	ele1.sendKeys("440");
			    	GenericMethods.driver.findElement(By.xpath("//table//tr["+i+"]//td[13]/img[@title='Save']")).click();
			    	savedWR=ele.getAttribute("value");
			    	break;
			    }			
			}
			return b;
