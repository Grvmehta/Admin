...
public class attachPackages {
	...
	public  WebElement window_title;

	@FindBy(xpath="//table[@class='poptable']//tr//td/select")
	public  WebElement packageType_drpDwn;
	//Centralized Rate

	@FindBy(xpath="//table/tbody//tr[2]//td[2]/input")
	public  WebElement package_CB;


	@FindBy(xpath="//div[@class='padtop10']//input[2]")
	public  WebElement attachRelational_BT;
	...
	public  WebElement attach_BT;
		...
		public  List<WebElement> master_chkbox;
		...
		public  WebElement Package3;

		@FindBy(xpath="//td[@id='tdCancellationPolicy_3']")
		public  WebElement PackageName3;
		...
		public  WebElement pkg1;

		@FindBy(xpath="//table[@class='poptable']/tbody//tr[4]//td[4]")
		public  WebElement pkg3;


		@FindBy(xpath="//input[@name='save']")
	    public  WebElement Attach_Btn;
        ...
        public  ListOfPackagesTravelAgent clk_closeBtn() throws Exception
        {
        ...
        public  ListOfPackagesTravelAgent1 clk_closeButton() throws Exception
        {
        	GenericMethods.clickElement(close_btn);
	...
	public  ListOfPackagesFrontdesk verify_window() throws InterruptedException
	{
	...
	public  void  verify_windowTitle() throws InterruptedException
	{
		//String childID=GenericMethods.windowHandle_admin(ListOfPackagesFrontdesk.windowID);
		String data=GenericMethods.getText(window_title);
		Assert.assertEquals(data, title_txt);
	...
	public  ListOfPackagesTravelAgent1 selectPkg_TAfrmFD(String pkgName) throws Exception
	{
		try
		{
		GenericMethods.selectElement(packageType_drpDwn, "Frontdesk");
		GenericMethods.driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		getPkgName( pkgName);
		GenericMethods.clickElement(attachRelational_BT);
	...
	public  void selectSpecifiedPackage1TA(String pkgType) throws Exception
	{
		try
		{
			GenericMethods.selectElement(packageType_drpDwn, pkgType);
	...
	public  ListOfPackagesFrontdesk selectPkg1_attachFD() throws Exception
	{
		try
		{
		//String childID=GenericMethods.windowHandle_admin(ListOfPackagesFrontdesk.windowID);
	...
	public  ListOfPackagesTravelAgent1 selectPkg1_attachTARelational() throws Exception
	{
		try
		{
		GenericMethods.clickElement(chkbox3);
	...
	public  GroupBookingSource selectPkg1_attachGrpBookingsource() throws Exception
	{
	...
	public  ListOfPackagesFrontdesk AttachToFrondesk() throws Exception
	{
        int
	...
	public  ListOfPackagesFrontdesk search_pkg() throws Exception
	{
		//String childID=GenericMethods.windowHandle_admin(ListOfPackagesFrontdesk.windowID);
		int count=GenericMethods.tr_count(master_chkbox);
	...
	public  ListOfPackagesFrontdesk AttachToFrondeskTC() throws Exception
	{
