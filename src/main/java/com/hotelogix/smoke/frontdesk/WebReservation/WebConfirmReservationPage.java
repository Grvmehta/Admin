...
//
		...
		GenericMethods.sendKeys(FirstName_ED,fName);
		
		lName=GenericMethods.generateRandomString();
		GenericMethods.sendKeys(LastName_ED, lName);
		
		GenericMethods.sendKeys(TelephoneNum_ED, "8506853589");
		GenericMethods.sendKeys(MobileNum_ED, "1213456");
		
		String Email=GenericMethods.generateRandomString()+"@stayezee.com";
		GenericMethods.sendKeys(Email_ED, Email);
		GenericMethods.sendKeys(ConfirmEmail_ED, Email);
