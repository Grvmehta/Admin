...
public class WebSelectRoomPage
{
	...
	public void fn_CheckWebRate() throws InterruptedException
    {
	...
	public static String  packageVerify(String pkgRate) throws InterruptedException
	{
...
//		int a=abc.size();
	          ...
	          if(nameRoomType1.equals(name))
	            {
		            ...
		            System.out.println("pkgPrice::"+pkgPrice);
		            String priceOfPackage = pkgRate;
	...
	public void verify_LastMinPrice() throws Exception
	{
        ...
        Assert.assertEquals(arr.add("Last Min Rate"), true);
		}
		catch(AssertionError e)
		{
			throw e;
